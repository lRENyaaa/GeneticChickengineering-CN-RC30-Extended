...
public final class GCEItems {
    ...
    public static final SlimefunItemStack EXCITATION_CHAMBER_10 = new SlimefunItemStack("GCE_EXCITATION_CHAMBER_10", new ItemStack(Material.BLAST_FURNACE), "§e高级鼓舞室", "§r§7§o鸡产生资源的地方", "§r§7§o速度最快", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), LoreBuilder.powerPerSecond(100));
